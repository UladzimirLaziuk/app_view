"""
Django settings for app_view project.
...
WSGI_APPLICATION = 'app_view.wsgi.application'
...
CELERY_IMPORTS = ("app_view.tasks",)

URL_DATA = os.getenv("URL_DATA")

PATH_URL_REFRESH = os.getenv("PATH_URL_REFRESH")
